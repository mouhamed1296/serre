  ...
  return(
    <div className='w-1/6 m-5 bg-white absolute rounded-lg drop-shadow-lg'>
        ...
        <div className='flex justify-center m-6'>
          <button className="bg-emerald-100 hover:bg-emerald-600 py-3 px-4 w-44 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
        ...
        <div className='flex justify-center m-6'>
          <button className="bg-emerald-100 hover:bg-emerald-600 py-3 px-4 w-44 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
            ...
            <span className='ml-2'>Historiques</span>
          </button>
        </div>
        <div className='flex justify-center m-6'>
          <button className="bg-emerald-100 hover:bg-emerald-600 py-3 px-4 w-44 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
            ...
            <span className='ml-2'>Paramétrages</span>
          </button>
        </div>
        <div className='flex justify-center m-6'>
          <button className="bg-emerald-100 hover:bg-emerald-600 py-3 px-4 w-44 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
        ...
        <div className='flex justify-center m-6 text-white'>
          <button className="bg-emerald-600 py-3 px-4 w-44 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
